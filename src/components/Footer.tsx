                    ...
                    <div className="row">
                        <div className="col-xl-4 col-md-6 col-lg-3">
                            <div className="footer_widget">
                                <div className="footer_logo">
                                    <Link to="/">
                                        <img className="logoNotaire" src="/img/logo.png" alt="Logo" />
                                    </Link>
                                </div>
                        ...
                        <div className="col-xl-2 col-md-6 col-lg-2">
                            <div className="footer_widget">
                                ...
                                <ul>
                                    <li><a href="#">Conseil Patrimonial</a></li>
                                    <li><a href="#">Successions et héritages</a></li>
                                    <li><a href="#">Actes immobiliers</a></li>
                                    <li><a href="#">Contrats et actes authentiques</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-xl-2 col-md-6 col-lg-2">
