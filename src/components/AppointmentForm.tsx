                ...
                <div className="row align-items-center">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 mx-auto mb-5">
                        <div className="appointment_info bg-gray-50/50 p-8 rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50">
                            ...
                            <h3 className="mb-4 text-3xl font-bold font-serif text-gray-900">Prendre Rendez-vous</h3>
                            <p className="mb-8 text-gray-600">De nombreuses possibilités s’offrent à vous pour prendre rendez-vous avec notre étude, et
                                notre équipe se tient à votre disposition pour vous accompagner à chaque étape.</p>
