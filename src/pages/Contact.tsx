    ...
    return (
        <Layout>
            ...
            <section className="contact-section py-20 bg-gray-50/50">
                <div className="map-iframe-wrapper mb-12 pb-4 container mx-auto rounded-3xl overflow-hidden shadow-2xl shadow-gray-200" style={{ height: '450px' }}>
                    <MapContainer
                        center={position}
                        zoom={15}
                ...
                <div className="container mx-auto px-4">
                    <div className="row justify-content-center mb-12">
                        <div className="col-12 text-center">
                            <h1 className="text-4xl font-bold text-gray-900 mb-4 font-serif">Nous contacter</h1>
                        ...
                        <div className="col-lg-4 offset-lg-1">
                            <div className="h-full flex flex-col justify-center space-y-8">
                                <div className="media contact-info flex items-start p-6 bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 transition-transform hover:-translate-y-1 duration-300">
                                    <span className="contact-info__icon mr-4 text-[#a70000] text-3xl mt-1"><i className="ti-home"></i></span>
                                    <div className="media-body">
                                        <h3 className="text-xl font-bold text-gray-900 mb-1">Av. des FAR, Tétouan</h3>
                                        <p className="text-gray-600">Residence El Manzah, App A</p>
                                    </div>
                                </div>
                                <div className="media contact-info flex items-start p-6 bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 transition-transform hover:-translate-y-1 duration-300">
                                    <span className="contact-info__icon mr-4 text-[#a70000] text-3xl mt-1"><i className="ti-tablet"></i></span>
                                    <div className="media-body">
                                        <h3 className="text-xl font-bold text-gray-900 mb-1">+212 5 39 99 69 56</h3>
